...
createServer({
  models: {
    van: Model, // Correct model name should be singular: 'van'
  },

  seeds(server) {
    // Use unique data for each van to avoid confusion
  ...
  routes() {
    ...
    this.get("/vans/:id", (schema, request) => {
      ...
      return schema.vans.find(id) || new Response(404, {}, { error: "Van not found" }); // Return 404 if not found
    });
